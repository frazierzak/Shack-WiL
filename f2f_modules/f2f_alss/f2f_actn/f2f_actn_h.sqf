...
// ---------- OPFOR ----------
	...
	case "Mi17_rockets_RU_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Mi17_rockets_RU_back",38);
	};
	...
	case "Mi171Sh_rockets_CZ_EP1_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Mi171Sh_rockets_CZ_EP1_back",38);
	};
	// ---------- "Mi24_D" Mi-24D ----------
	case "Mi24_D_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Mi24_D_back",38);
	};
	...
	case "Mi24_D_TK_EP1_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Mi24_D_TK_EP1_back",38);
	};
	// ---------- "Mi24_P" Mi-24P ----------
	case "Mi24_P_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Mi24_P_back",38);
	};
	// ---------- "Mi24_V" Mi-24V ----------
	case "Mi24_V_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Mi24_V_back",38);
	};
	// ---------- "Ka52" Ka-52 ----------
	case "Ka52_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Ka52_back",38);
	};
// ---------- BLUFOR ----------
	// ---------- "AH64D" AH-64D ----------
	case "AH64D_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","AH64D_back",38);
	};
	...
	case "BAF_Apache_AH1_D_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","BAF_Apache_AH1_D_back",38);
	};
	// ---------- "AH1Z" AH-1Z ----------
	case "AH1Z_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","AH1Z_back",38);
	};
	// ---------- "AH6J_EP1" AH-6J ----------
	case "AH6J_EP1_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","AH6J_EP1_back",38);
	};
	// ---------- "UH1Y" UH-1Y ----------
	case "UH1Y_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","UH1Y_back",38);
	};
	...
	case "Ka60_GL_PMC_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Ka60_GL_PMC_back",38);
	};
	// ---------- "Ka60_PMC" Ka-60 ----------
	case "Ka60_PMC_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","Ka60_PMC_back",38);
	};
// ------------------------------------------
// ------------ Addon Helicopters -----------
// ------------------------------------------
	...
	case "UH60_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","UH60_back",35);
		_acClass0 = nil;
	};
	...
	case "ACE_Mi24_V_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_Mi24_V_back",38);
	};	
	...
	case "ACE_Mi24_V_CDF_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_Mi24_V_CDF_back",38);
	};
	...
	case "ACE_Mi24_V_FAB250_RU_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_Mi24_V_FAB250_RU_back",38);
	};
	...
	case "ACE_Mi24_V_FAB250_CDF_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_Mi24_V_FAB250_CDF_back",38);
	};
	...
	case "ACE_Mi24_P_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_Mi24_P_back",38);
	};
	// ---------- "ACE_Ka52" Ka-52 ACE ----------
	case "ACE_Ka52_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_Ka52_back",38);
	};
	...
	case "ACE_BAF_AH1_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_BAF_AH1_back",38);
	};
	...
	case "ACE_AH64D_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_AH64D_back",38);
	};
	...
	case "ACE_AH6J_DAGR_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_AH6J_DAGR_back",38);
	};
	...
	case "ACE_AH1Z_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_AH1Z_back",37);
	};
	...
	case "ACE_AH1W_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_AH1W_back",36);
	};
	...
	case "ACE_AH1W2_mm":
	{
		...
		ACTN_YL(actn_back,_tgt,"Exit F2F ALSS","f2f_actn\f2f_actn_back.sqf","ACE_AH1W2_back",36);
	};
// ------------------------------------------
